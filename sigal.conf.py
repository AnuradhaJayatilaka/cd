...
links = [('Find me on Instagram', 'https://instagram.com/cholesterol_diaries'),('My Website', 'https://anuradhajayatilaka.github.io')]
#          ('Another link', 'http://example.org')]

# Google Analytics tracking code (UA-xxxx-x)
google_analytics = 'UA-15776498-5'
